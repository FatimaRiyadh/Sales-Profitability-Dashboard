...
## Introduction
Company Performance Dashboard is an integrated interactive report built to clean and analyze sales and profitability data for branches and products. 
The project aims to transform raw data into interactive insights that support managerial and business decision-making.
...
its sales and the most requested products in it?
  Using the interactive filter on the dashboard, simply clicking the "Baghdad" option will instantly switch the entire dashboard to display
